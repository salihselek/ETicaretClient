...
export class ListComponent extends BaseComponent implements OnInit {
  ...
  async getProducts() {
    ...
    const allProducts: { totalProductCount: number, products: ListProduct[] } = await this.productService.read(this.paginator ? this.paginator.pageIndex : 0, this.paginator ? this.paginator.pageSize : 5,
